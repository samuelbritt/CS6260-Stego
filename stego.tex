...
$H_\infty\l( \channel_h^b \r) > 1 \forall h$ drawn from \channel. As
output, $\stgenc_k^M\l( m, h \r)$ returns a sequence $c_1 \concat c_2
\concat \ldots \concat c_\ell$ in the support of $\channel_h^{\ell
...
steganographic security. He considers the basic pr
